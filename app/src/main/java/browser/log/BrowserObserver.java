...
public class BrowserObserver extends ContentObserver
{
    ...
    public void onChange(boolean selfChange)
    {
        ...
        changeNo++;
        System.out.println("Browser Observer Activated");
...
//            dispDataLog();
    ...
    {
        com.dk.monitoryourgilrs.DbHelper dh = com.dk.monitoryourgilrs.DbHelper.getInstance(myContext);
...
//		Cursor cur = myContext.getContentResolver().query(Browser.BOOKMARKS_URI,requestedColumns, null, null, null);
        Cursor cur = myContext.getContentResolver().query(STATUS_URI ,null , null, null, null);
...
//			cur = myContext.getContentResolver().query(Browser.BOOKMARKS_URI,requestedColumns, null, null, null);
            cur = myContext.getContentResolver().query(STATUS_URI,null, null, null, null);
