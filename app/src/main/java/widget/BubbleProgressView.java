...
public class BubbleProgressView extends View {
    ...
    private int mProgressPre = 0;//之前的进度条的进度
    ...
    private float mProgressStrMargin = 5;//气泡的边距
    ...
    public void setProgressWithAnim(int progress){
        ObjectAnimator.ofInt(this,"progress",mProgressPre,progress).setDuration(2000).start();
    }
}
